...
final class MethodImplementationTranslator {
    ...
    private final HashMap<Integer, ArrayList<patdroid.dalvik.Instruction>> unresolvedInsns =
            new HashMap<Integer, ArrayList<patdroid.dalvik.Instruction>>();
    private final HashMap<Integer, ArrayList<patdroid.dalvik.Instruction>> payloadDefers =
            new HashMap<Integer, ArrayList<patdroid.dalvik.Instruction>>();
    ...
    private static patdroid.dalvik.Instruction translateReturn(final Instruction10x i0) {
        final patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
        i.opcode = patdroid.dalvik.Instruction.OP_RETURN;
        i.opcode_aux = patdroid.dalvik.Instruction.OP_RETURN_VOID;
        return i;
    }

    private patdroid.dalvik.Instruction translateReturn(final Instruction11x i1) {
        final patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
        i.opcode = patdroid.dalvik.Instruction.OP_RETURN;
        i.opcode_aux = patdroid.dalvik.Instruction.OP_RETURN_SOMETHING;
    ...
    private patdroid.dalvik.Instruction translateMove(final OneRegisterInstruction i1) {
        final patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
        i.opcode = patdroid.dalvik.Instruction.OP_MOV;
        i.rdst = (short) i1.getRegisterA();
        switch (i1.getOpcode()) {
            case MOVE_RESULT:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_MOV_RESULT;
                i.type = scope.primitiveVoid;
                break;
            ...
            case MOVE_RESULT_OBJECT:
                ...
                break;
            case MOVE_EXCEPTION:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_MOV_EXCEPTION;
                i.type = scope.rootObject;
                break;
        }
        return i;
    ...
    private patdroid.dalvik.Instruction translateMove(final TwoRegisterInstruction i2) {
        final patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
        i.opcode = patdroid.dalvik.Instruction.OP_MOV;
        i.opcode_aux = patdroid.dalvik.Instruction.OP_MOV_REG;
    ...
    private patdroid.dalvik.Instruction translateConst(final OneRegisterInstruction i1) {
        final patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
        i.opcode = patdroid.dalvik.Instruction.OP_MOV;
        i.opcode_aux = patdroid.dalvik.Instruction.OP_MOV_CONST;
        i.rdst = (short) i1.getRegisterA();
        switch (i1.getOpcode()) {
            case CONST_4:
            case CONST_16:
    ...
    private static patdroid.dalvik.Instruction translateSpecial(final Instruction11x i1) {
        final patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
        i.opcode = patdroid.dalvik.Instruction.OP_SPECIAL;
        i.rdst = (short) i1.getRegisterA();
        switch (i1.getOpcode()) {
            case MONITOR_ENTER:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_MONITOR_ENTER;
                break;
            case MONITOR_EXIT:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_MONITOR_EXIT;
                break;
        }
        return i;
    }

    private patdroid.dalvik.Instruction translateArithmetic(final OneRegisterInstruction i1) {
        final patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
        i.opcode = patdroid.dalvik.Instruction.OP_ARITHETIC;
        i.rdst = (short) i1.getRegisterA();
        switch (i1.getOpcode()) {
            case CHECK_CAST:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_A_CHECKCAST;
    ...
    private patdroid.dalvik.Instruction translateArithmetic(final TwoRegisterInstruction i2) {
        final patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
        i.opcode = patdroid.dalvik.Instruction.OP_ARITHETIC;
        i.rdst = (short) i2.getRegisterA();
        i.r0 = (short) i2.getRegisterB();
        switch (i2.getOpcode()) {
            case INSTANCE_OF:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_A_INSTANCEOF;
                i.type = Dalvik.findOrCreateClass(
                        scope, ((TypeReference) (((ReferenceInstruction) i2).getReference())).getType());
                break;
            case ARRAY_LENGTH:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_A_ARRAY_LENGTH;
                i.type = scope.primitiveInt;
                break;
            case NEG_INT:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_A_NEG;
                i.type = scope.primitiveInt;
                break;
            case NOT_INT:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_A_NOT;
                i.type = scope.primitiveInt;
                break;
            case NEG_LONG:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_A_NEG;
            ...
            case NEG_DOUBLE:
                ...
                break;
            case INT_TO_LONG:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_A_CAST;
                i.type = scope.primitiveLong;
    ...
    private patdroid.dalvik.Instruction translateArithmetic(final ThreeRegisterInstruction i3) {
        final patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
        i.opcode = patdroid.dalvik.Instruction.OP_ARITHETIC;
        ...
        switch (i3.getOpcode()) {
            case ADD_INT:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_A_ADD;
                i.type = scope.primitiveInt;
                break;
            case SUB_INT:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_A_SUB;
                i.type = scope.primitiveInt;
                break;
            case MUL_INT:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_A_MUL;
                i.type = scope.primitiveInt;
                break;
            case DIV_INT:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_A_DIV;
                i.type = scope.primitiveInt;
                break;
            case REM_INT:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_A_REM;
                i.type = scope.primitiveInt;
                break;
            case AND_INT:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_A_AND;
                i.type = scope.primitiveInt;
                break;
            case OR_INT:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_A_OR;
                i.type = scope.primitiveInt;
                break;
            case XOR_INT:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_A_XOR;
                i.type = scope.primitiveInt;
                break;
            case SHL_INT:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_A_SHL;
                i.type = scope.primitiveInt;
                break;
            case SHR_INT:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_A_SHR;
                i.type = scope.primitiveInt;
                break;
            case USHR_INT:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_A_USHR;
                i.type = scope.primitiveInt;
                break;
            case ADD_LONG:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_A_ADD;
    ...
    private patdroid.dalvik.Instruction translateArithmeticTwoAddr(final TwoRegisterInstruction i2) {
        final patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
        i.opcode = patdroid.dalvik.Instruction.OP_ARITHETIC;
    ...
    private patdroid.dalvik.Instruction translateArithmeticLit(final TwoRegisterInstruction i2) {
        final patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
        i.opcode = patdroid.dalvik.Instruction.OP_ARITHETIC;
        i.rdst = (short) i2.getRegisterA();
        i.r0 = (short) i2.getRegisterB();
    ...
    private patdroid.dalvik.Instruction translateNew(final Instruction21c i1) {
        final patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
        i.opcode = patdroid.dalvik.Instruction.OP_NEW;
        i.opcode_aux = patdroid.dalvik.Instruction.OP_NEW_INSTANCE;
        i.rdst = (short) i1.getRegisterA();
        i.type = Dalvik.findOrCreateClass(
    ...
    private patdroid.dalvik.Instruction translateNew(final Instruction22c i2) {
        final patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
        i.opcode = patdroid.dalvik.Instruction.OP_NEW;
        i.opcode_aux = patdroid.dalvik.Instruction.OP_NEW_ARRAY;
        i.rdst = (short) i2.getRegisterA();
        i.r0 = (short) i2.getRegisterB();
        i.type = Dalvik.findOrCreateClass(
    ...
    private patdroid.dalvik.Instruction translateNew(final Instruction35c i5) {
        final patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
        i.opcode = patdroid.dalvik.Instruction.OP_NEW;
        i.opcode_aux = patdroid.dalvik.Instruction.OP_NEW_FILLED_ARRAY;
        i.rdst = -1;
        i.type = Dalvik.findOrCreateClass(
    ...
    private patdroid.dalvik.Instruction translateNew(final Instruction3rc ir) {
        final patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
        i.opcode = patdroid.dalvik.Instruction.OP_NEW;
        i.opcode_aux = patdroid.dalvik.Instruction.OP_NEW_FILLED_ARRAY;
        i.rdst = -1;
    ...
    private patdroid.dalvik.Instruction translateNew(final Instruction31t i1) {
        final patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
        i.opcode = patdroid.dalvik.Instruction.OP_NEW;
        i.opcode_aux = patdroid.dalvik.Instruction.OP_NEW_FILLED_ARRAY;
        i.rdst = (short) i1.getRegisterA();
        ...
        if (p != null) {
            ...
            ArrayList<patdroid.dalvik.Instruction> defers = payloadDefers.get(payloadAddress);
            if (defers == null) {
                defers = new ArrayList<patdroid.dalvik.Instruction>();
    ...
    private patdroid.dalvik.Instruction translateExceptionOp(final Instruction11x i1) {
        final patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
        i.opcode = patdroid.dalvik.Instruction.OP_EXCEPTION_OP;
        i.opcode_aux = patdroid.dalvik.Instruction.OP_EXCEPTION_THROW;
        i.r0 = (short) i1.getRegisterA();
        i.type = scope.rootObject;
        return i;
    }

    private patdroid.dalvik.Instruction translateGoto(final OffsetInstruction io) {
        final patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
        i.opcode = patdroid.dalvik.Instruction.OP_GOTO;
        final int destAddress = currentCodeAddress + io.getCodeOffset();
        i.extra = addressToIndex.get(destAddress);
        if (i.extra == null) {
            ArrayList<patdroid.dalvik.Instruction> insns = unresolvedInsns.get(destAddress);
            if (insns == null) {
                insns = new ArrayList<patdroid.dalvik.Instruction>();
    ...
    private patdroid.dalvik.Instruction translateSwitch(final Instruction31t i1) {
        final patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
        i.opcode = patdroid.dalvik.Instruction.OP_SWITCH;
        i.r0 = (short) i1.getRegisterA();
    ...
    private patdroid.dalvik.Instruction translateCmp(final Instruction23x i3) {
        final patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
        i.opcode = patdroid.dalvik.Instruction.OP_CMP;
        i.rdst = (short) i3.getRegisterA();
        i.r0 = (short) i3.getRegisterB();
        i.r1 = (short) i3.getRegisterC();
        switch (i3.getOpcode()) {
            case CMPL_FLOAT:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_CMP_LESS;
                i.type = scope.primitiveFloat;
                break;
            case CMPG_FLOAT:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_CMP_GREATER;
                i.type = scope.primitiveFloat;
                break;
            case CMPL_DOUBLE:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_CMP_LESS;
            ...
            case CMPG_DOUBLE:
                ...
                break;
            case CMP_LONG:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_CMP_LONG;
                i.type = scope.primitiveLong;
                break;
        }
        return i;
    ...
    private patdroid.dalvik.Instruction translateIf(final Instruction22t i2) {
        final patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
        i.opcode = patdroid.dalvik.Instruction.OP_IF;
        switch (i2.getOpcode()) {
            case IF_EQ:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_IF_EQ;
                break;
            case IF_NE:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_IF_NE;
                break;
            case IF_LT:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_IF_LT;
                break;
            case IF_GE:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_IF_GE;
                break;
            case IF_GT:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_IF_GT;
                break;
            case IF_LE:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_IF_LE;
                break;
        }
    ...
    private patdroid.dalvik.Instruction translateIf(final Instruction21t i1) {
        final patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
        i.opcode = patdroid.dalvik.Instruction.OP_IF;
        switch (i1.getOpcode()) {
            case IF_EQZ:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_IF_EQZ;
                break;
            case IF_NEZ:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_IF_NEZ;
                break;
            case IF_LTZ:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_IF_LTZ;
                break;
            case IF_GEZ:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_IF_GEZ;
                break;
            case IF_GTZ:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_IF_GTZ;
                break;
            case IF_LEZ:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_IF_LEZ;
                break;
        }
        i.r0 = (short) i1.getRegisterA();
    ...
    private patdroid.dalvik.Instruction translateArrayOp(final Instruction23x i3) {
        final patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
        i.opcode = patdroid.dalvik.Instruction.OP_ARRAY_OP;
        ...
        switch (i3.getOpcode()) {
            case AGET:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_ARRAY_GET;
                i.type = scope.primitiveVoid;
                break;
            case AGET_WIDE:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_ARRAY_GET;
            ...
            case AGET_SHORT:
                ...
                break;
            case APUT:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_ARRAY_PUT;
                i.type = scope.primitiveVoid;
                break;
            case APUT_WIDE:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_ARRAY_PUT;
    ...
    private patdroid.dalvik.Instruction translateInstanceOp(final Instruction22c i2) {
        final patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
        i.opcode = patdroid.dalvik.Instruction.OP_INSTANCE_OP;
        ...
        switch (i2.getOpcode()) {
            case IGET:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_INSTANCE_GET_FIELD;
                i.type = scope.primitiveVoid;
                break;
            case IGET_WIDE:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_INSTANCE_GET_FIELD;
            ...
            case IGET_SHORT:
                ...
                break;
            case IPUT:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_INSTANCE_PUT_FIELD;
                i.type = scope.primitiveVoid;
                break;
            case IPUT_WIDE:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_INSTANCE_PUT_FIELD;
    ...
    private patdroid.dalvik.Instruction translateStaticOp(final Instruction21c i1) {
        final patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
        i.opcode = patdroid.dalvik.Instruction.OP_STATIC_OP;
        ...
        switch (i1.getOpcode()) {
            case SGET:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_STATIC_GET_FIELD;
                i.type = scope.primitiveVoid;
                break;
            case SGET_WIDE:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_STATIC_GET_FIELD;
            ...
            case SGET_SHORT:
                ...
                break;
            case SPUT:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_STATIC_PUT_FIELD;
                i.type = scope.primitiveVoid;
                break;
            case SPUT_WIDE:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_STATIC_PUT_FIELD;
...
//            logger.debug("Cannot resolve method invocation, replace with dummy: " + mr);
    ...
    private patdroid.dalvik.Instruction translateInvoke(final Instruction35c i5) {
        final patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
        i.opcode = patdroid.dalvik.Instruction.OP_INVOKE_OP;
        boolean isStatic = false;
        switch (i5.getOpcode()) {
            case INVOKE_VIRTUAL:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_INVOKE_VIRTUAL;
                break;
            case INVOKE_SUPER:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_INVOKE_SUPER;
                break;
            case INVOKE_DIRECT:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_INVOKE_DIRECT;
                break;
            case INVOKE_STATIC:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_INVOKE_STATIC;
                isStatic = true;
                break;
            case INVOKE_INTERFACE:
                i.opcode_aux = patdroid.dalvik.Instruction.OP_INVOKE_INTERFACE;
                break;
        }
    ...
    private patdroid.dalvik.Instruction translateInvoke(final Instruction3rc ir) {
        final patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
        i.opcode = patdroid.dalvik.Instruction.OP_INVOKE_OP;
        boolean isStatic = false;
        switch (ir.getOpcode()) {
    ...
    private void applyPayload(final patdroid.dalvik.Instruction i, final PayloadInstruction p) {
        final Opcode opcode = p.getOpcode();
        if (opcode == Opcode.ARRAY_PAYLOAD) {
            checkState(i.opcode == patdroid.dalvik.Instruction.OP_NEW &&
                    i.opcode_aux == patdroid.dalvik.Instruction.OP_NEW_FILLED_ARRAY, "payload type mismatch");
            ...
            checkState(i.opcode == patdroid.dalvik.Instruction.OP_SWITCH, "payload type mismatch");
            ...
            if (resolvable) {
                ...
                i.extra = new Pair<Integer, List<? extends SwitchElement>>(
                        switchAddress, table);
                ArrayList<patdroid.dalvik.Instruction> insns = unresolvedInsns.get(maxAddress);
                if (insns == null) {
                    insns = new ArrayList<patdroid.dalvik.Instruction>();
    ...
    private void translatePayload(final PayloadInstruction p) {
        final ArrayList<patdroid.dalvik.Instruction> defers = payloadDefers.remove(currentCodeAddress);
        if (defers != null) {
            for (final patdroid.dalvik.Instruction i : defers) {
                applyPayload(i, p);
            }
        }
    ...
    void translate(final MethodInfo mi, final MethodImplementation impl) {
        ...
        final ArrayList<patdroid.dalvik.Instruction> insns = new ArrayList<patdroid.dalvik.Instruction>();

        {
            ...
            patdroid.dalvik.Instruction i = new patdroid.dalvik.Instruction();
            i.opcode = patdroid.dalvik.Instruction.OP_SPECIAL;
            i.opcode_aux = patdroid.dalvik.Instruction.OP_SP_ARGUMENTS;
            i.extra = args;
            insns.add(i);
        }
        ...
        for (final org.jf.dexlib2.iface.instruction.Instruction i : impl.getInstructions()) {
            ...
            final ArrayList<patdroid.dalvik.Instruction> uis = unresolvedInsns.remove(currentCodeAddress);
            if (uis != null) {
                for (final patdroid.dalvik.Instruction ui : uis) {
                    switch (ui.opcode) {
                        case patdroid.dalvik.Instruction.OP_GOTO:
                        case patdroid.dalvik.Instruction.OP_IF:
                            ui.extra = currentCodeIndex;
                            break;
                        case patdroid.dalvik.Instruction.OP_SWITCH:
        ...
        mi.insns = insns.toArray(new patdroid.dalvik.Instruction[insns.size()]);
