...
public final class ClassDetail {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ClassDetail.class);
    ...
    public ClassInfo getFieldType(String fieldName) {
        ...
        if (r != null) {
            ...
            if (baseType == null) {
                logger.warn("failed to find field: "+ fieldName);
                return null;
            }
    ...
    public ClassInfo getStaticFieldType(String fieldName) {
        ...
        if (r != null) {
            ...
            if (baseType == null) {
                logger.warn("failed to find static field: "+ fieldName);
                return null;
            }
