...
public final class Instruction {
    ...
    public String getOP(){
        return opname[(int)opcode];
    }
    public String getOpaux_name(){
        return opaux_name[(int)opcode_aux];
    }

    public JSONObject inst2JSON(){
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("opcode", opcode);
        jsonObject.put("opcode_aux",opcode_aux);
        jsonObject.put("rdst", rdst);
